...
write.table(AIC_scores,file="AIC_Models_scores.txt")
write.table(BIC_scores,file="BIC_Models_scores.txt")
...
write.table(AIC.BIC.weight(AIC_scores[1:3]),file="AIC_Models02_weights.txt")
write.table(AIC.BIC.weight(BIC_scores[1:3]),file="BIC_Models02_weights.txt")
write.table(AIC.BIC.weight(AIC_scores[1:4]),file="AIC_Models03_weights.txt")
write.table(AIC.BIC.weight(BIC_scores[1:4]),file="BIC_Models03_weights.txt")
write.table(AIC.BIC.weight(AIC_scores),file="AIC_Models04_weights.txt")
write.table(AIC.BIC.weight(BIC_scores),file="BIC_Models04_weights.txt")
